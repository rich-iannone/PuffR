...
Let's generate a geophysical input file for CALMET. This will consist of a grid centered on 49.5ºN and 125.30364ºW. The width (E-W distance) of the grid will be 8000 m, and the height (N-S distance) will be the same. We will elect to download SRTM terrain height data from "http://gis-lab.info/data/srtm-tif/".
```{r}
