...
calpuff_11_chem_params <- function(calpuff_inp = "calpuff_template.txt",
  ...
  # Generate a formatted character string for 'bcko3'
  bcko3 <- paste(bcko3, collapse = ", ")
  ...
  # Generate a formatted character string for 'bckpmf'
  bckpmf <- paste(bckpmf, collapse = ", ")
  
  # Generate a formatted character string for 'ofrac'
  ofrac <- paste(ofrac, collapse = ", ")
  
  # Generate a formatted character string for 'vcnx'
  vcnx <- paste(vcnx, collapse = ", ")
