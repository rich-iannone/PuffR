...
calpuff_create_varying_point_sources <- function(CSV_input = NULL,
  ...
  geo_dat_UTM_zone <- gsub(" ", "", geo_dat_lines[grep("UTM", geo_dat_lines) + 1])
  ...
  surf_dat_tz <- gsub(" ", "", surf_dat_lines[grep("UTC([+|-])", surf_dat_lines)])
  ...
  header_4 <- "UTM"
  header_5 <- geo_dat_UTM_zone
  header_6 <- "WGS-84"
  header_7 <- "  KM"
  header_8 <- surf_dat_tz
